...
const config: Config = {
  ...
  theme: {
    ...
    extend: {
      ...
      fontSize: {
        'fluid-xs': 'clamp(0.75rem, 0.725rem + 0.125vw, 0.875rem)',
        'fluid-base': 'clamp(0.9375rem, 0.9rem + 0.1875vw, 1.125rem)',
        'fluid-lg': 'clamp(1.125rem, 1.05rem + 0.375vw, 1.5rem)',
        'fluid-xl': 'clamp(1.5rem, 1.35rem + 0.75vw, 2.25rem)',
        'fluid-2xl': 'clamp(2rem, 1.7rem + 1.5vw, 3.5rem)',
      ...
      spacing: {
        ...
        'fluid-padding': 'clamp(2.5rem, 1.8rem + 3.5vw, 6rem)',
        '18': '4.5rem',
        '22': '5.5rem',
        '30': '7.5rem',
      },
